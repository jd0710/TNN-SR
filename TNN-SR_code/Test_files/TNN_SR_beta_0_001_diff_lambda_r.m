...
% fixed beta, test different lambda's and r's
% lambda_set = [0.001, 0.01, 0.05, 0.1, 0.5, 1, 5, 10]; 
% r_set = [1 3 9 15 25 50 100 200];    
% beta = 0.001;
