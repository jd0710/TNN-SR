...
function [ret] = TNN_SR(matrix_pic,matrix_mask,R,lambda, beta) 
% This function implements the TNN-SR algorithm 
...
for i = 1:3 % for different color channel
    ...
    for out_iter = 1:number_of_out_iter
        ...
        [X_rec(:,:,out_iter)] = admmAXB_L1(A,B,X,M,known,beta,lambda);
